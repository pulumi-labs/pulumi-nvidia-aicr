...
components are in scope.`)
	an.Describe(&c.Accelerator, `GPU accelerator type. Supported values: "h100", "gb200", "gb300", "b200", "rtx-pro-6000", "vr200"; each is admitted only on the services with its tuned recipes (h100: aks, bcm, eks, gke, kind, lke; gb200: eks, oke; gb300: eks, generic; b200: gke; rtx-pro-6000: eks, lke; vr200: rke2).`)
	an.Describe(&c.Service, `Kubernetes service. Supported values: "aks", "bcm", "eks", "generic", "gke", "kind", "lke", "oke", "rke2".`)
