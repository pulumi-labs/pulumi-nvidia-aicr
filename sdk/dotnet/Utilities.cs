...
namespace Pulumi.Labs.NvidiaAicr
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-labs/pulumi-nvidia-aicr";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Labs.NvidiaAicr.version.txt");
    ...
    internal sealed class NvidiaAicrResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NvidiaAicrResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
