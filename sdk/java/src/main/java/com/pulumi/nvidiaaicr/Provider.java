...
import com.pulumi.nvidiaaicr.ProviderArgs;
import com.pulumi.nvidiaaicr.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:nvidia-aicr")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nvidia-aicr", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
