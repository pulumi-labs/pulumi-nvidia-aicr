...
class RecipeCriteriaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] accelerator: GPU accelerator type. Supported values: "h100", "gb200", "gb300", "b200", "rtx-pro-6000", "vr200"; each is admitted only on the services with its tuned recipes (h100: aks, bcm, eks, gke, kind, lke; gb200: eks, oke; gb300: eks, generic; b200: gke; rtx-pro-6000: eks, lke; vr200: rke2).
        :param pulumi.Input[_builtins.str] intent: Workload intent. Supported values: "training", "inference".
        :param pulumi.Input[_builtins.str] service: Kubernetes service. Supported values: "aks", "bcm", "eks", "generic", "gke", "kind", "lke", "oke", "rke2".
